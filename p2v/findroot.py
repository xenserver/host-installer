...
def rio_handle_root(xapi_host, p2v_vm_uuid, mntpnt, dev_name, session, pd = None):
    ...
    path = "http://" + p2v_vm_uuid + ":81/unpack-tar?" + urllib.urlencode({'volume': 'xvda1', 'compression': 'bzip2', 'session_id': session})

...
def select_netif(text, conf, default=None):
    ...
    def iface_details(context):
        ...
        id_grid.setField(driver_text, 0, 1)
        id_grid.setField(driver_val, 1, 1, anchorLeft = 1)
        id_grid.setField(mac_text, 0, 2)
        id_grid.setField(mac_val, 1, 2, anchorLeft = 1)
        id_grid.setField(pci_text, 0, 3)
        id_grid.setField(pci_val, 1, 3, anchorLeft = 1)
